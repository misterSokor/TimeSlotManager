...
//import com.auth0.jwt.interfaces.DecodedJWT;
//import com.fasterxml.jackson.databind.ObjectMapper;
//import com.petersokor.TimeSlotManager.auth.*;
//import com.petersokor.TimeSlotManager.util.PropertiesLoader;
...
//                req.setAttribute("userName", userName);
//            } catch (IOException e) {
//                logger.info("Error getting or validating the token: " + e.getMessage(), e);
//                logger.info("TOKEN IS NOT VALID");
//                resp.sendRedirect("error.html");
//            } catch (InterruptedException e) {
//                logger.info("Error getting token from Cognito oauth url " + e.getMessage(), e);
//                logger.info("NOT GETTING A TOKEN");
//                resp.sendRedirect("error.html");
//            }
//        }
//        RequestDispatcher dispatcher = req.getRequestDispatcher("index.html");
...
//            logger.info("Invalid Key Error " + e.getMessage(), e);
//        } catch (NoSuchAlgorithmException e) {
//            logger.info("Algorithm Error " + e.getMessage(), e);
//        }
//
...
//        logger.info("here are all the available claims: " + jwt.getClaims());
//
